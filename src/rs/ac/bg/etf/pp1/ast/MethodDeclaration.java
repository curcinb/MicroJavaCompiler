...
public class MethodDeclaration extends MethDecl {
    ...
    public MethodDeclaration (MethTypeName MethTypeName, FormParameters FormParameters, VarDeclList VarDeclList, StatementList StatementList) {
